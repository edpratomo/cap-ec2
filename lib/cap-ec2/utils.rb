...
module CapEC2
  module Utils
    ...
    def self.contact_point(instance)
      ...
      available_contact_points = [ instance.public_dns_name, instance.public_ip_address, instance.private_ip_address ].reject {|e| e.nil?}.reject {|e| e.empty?}
      available_contact_points.first
    end
